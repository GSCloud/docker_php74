...
RUN apt-get update -qq && apt-get install -yqq --no-install-recommends curl haveged openssl software-properties-common language-pack-en-base language-pack-en && locale-gen en_US.UTF-8
